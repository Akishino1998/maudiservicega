					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo_container">
								<a href="#">
									<div class="logo_text"> <img src="images\logo\logonyervisga.png" alt="Nyevirga?"> </div>
								</a>
							</div>
	...
	<div class="home">
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(images/slider/slider_ex_1.jpg)"></div>
					<div class="home_slider_content">
						<div class="container">
							<div class="row">
								<div class="col text-center">
									<div class="home_slider_title font-color-white">Service Elekronikmu Tanpa Harus Keluar Rumah</div>
									<div class="home_slider_subtitle font-color-f2f2f2">
										<i>
											<a href="https://kbbi.web.id/tenteng" class="font-color-f2f2f2" style="color:#f2f2f2">Nenteng</a>
										</i>
										TV itu berat, biar <span style="color:black;">Nyervis<span style="color:#14BDEE;">ga</span>?</span> aja", Dilanku 1990</div>
									<div class="home_slider_form_container ">
										<form action="#" id="home_search_form_1" class="home_search_form d-flex flex-lg-row flex-column align-items-center justify-content-between">
			...
			<div class="row features_row">
				...
				<div class="col-lg-3 feature_col hvr-grow">
					<div class="feature text-center trans_400">
						...
						<h3 class="feature_title">Delivery</h3>
